...
@override
String toString() {
  return 'Empresa(idEmpresa: $idEmpresa, codigoEmpresa: $codigoEmpresa, nombre: $nombre, cif: $cif, direccion: $direccion, ciudad: $ciudad, pais: $pais, fechaCreacion: $fechaCreacion, cantidadUsuarios: $cantidadUsuarios, cantidadEmpleados: $cantidadEmpleados)';
}
...
switch (_that) {
case _Empresa():
return $default(_that.idEmpresa,_that.codigoEmpresa,_that.nombre,_that.cif,_that.direccion,_that.ciudad,_that.pais,_that.fechaCreacion,_that.cantidadUsuarios,_that.cantidadEmpleados);}
}
...
class _Empresa implements Empresa {
  const _Empresa({this.idEmpresa, required this.codigoEmpresa, required this.nombre, required this.cif, this.direccion, this.ciudad, this.pais, this.fechaCreacion, this.cantidadUsuarios, this.cantidadEmpleados});
  factory _Empresa.fromJson(Map<String, dynamic> json) => _$EmpresaFromJson(json);
